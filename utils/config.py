...
PERMUTE_K_SUBBLOCKS = os.getenv('PERMUTE_K_SUBBLOCKS', "all")# "all" to permute all
...
LOG_MATRIX = os.getenv('LOG_MATRIX', 'True').lower() == 'true'
...
MAX_SOLVE_TIME = int(os.getenv('NUMBER_OF_PERMUTATIONS', 7200))

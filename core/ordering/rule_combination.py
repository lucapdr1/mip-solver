...
class RuleComposition(OrderingRule):
    ...
    def score_variables(self, vars, obj_coeffs, bounds, A, A_csc, A_csr, constraints, rhs):
        ...
        for rule in self.rules:
            rule_scores = rule.score_variables(vars, obj_coeffs, bounds, A, A_csc, A_csr, constraints, rhs)
    ...
    def score_constraints(self, vars, obj_coeffs, bounds, A, A_csc, A_csr, constraints, rhs):
        ...
        for rule in self.rules:
            ...
            rule_scores = rule.score_constraints(vars, obj_coeffs, bounds, A, A_csc, A_csr, constraints, rhs)

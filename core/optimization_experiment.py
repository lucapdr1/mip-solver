...
from utils.config import PERMUTE_ORIGINAL, PERMUTE_GRANULARITY_K, LOG_MODEL_COMPARISON, LOG_MATRIX, PRODUCTION, BUCKET_NAME, SCALING_ACTIVE, NORMALIZATION_ACTIVE, DISABLE_SOLVING, RECURSIVE_RULES, MAX_SOLVE_TIME
...
class OptimizationExperiment:
    ...
    def run_experiment(self, num_iterations):
        ...
        if PERMUTE_ORIGINAL:
            ...
            baseline_model, baseline_var_order, baseline_constr_order, _, _ = self.permutator.create_permuted_problem(PERMUTE_GRANULARITY_K)
        else:
        ...
        for i in range(num_iterations):
            ...
            try:
                ...
                permuted_distance, canonical_distance) = self.run_single_iteration(
                    baseline_var_order, baseline_constr_order, final_canonical_var_order, final_canonical_constr_order
                )
    ...
    def run_single_iteration(self, baseline_var_order, baseline_constr_order, original_canonical_var_order, original_canonical_constr_order):
        try:
            ...
            permuted_model, var_permutation, constr_permutation, _, _ = self.permutator.create_permuted_problem(PERMUTE_GRANULARITY_K)

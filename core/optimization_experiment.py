...
from core.problem_transform.problem_normalizer import Normalizer
...
class OptimizationExperiment:
    ...
    def run_single_iteration(self, original_result, canonical_from_original_result, 
        ...
        try:
            ...
            # Compute composed (final) permutation order:
    ...
    def run_experiment(self, num_iterations):
        ...
        for i in range(num_iterations):
            ...
            try:
                iteration_result = self.run_single_iteration(
                    original_result, canonical_from_original_result,
                    original_canonical, original_canonical_var_order, original_canonical_constr_order
                )
        ...
        self.performance_evaluator.compute_solve_time_variability_std(results)
        self.performance_evaluator.compute_distance_variability_std(results)
        return results

...
from utils.config import LOG_MODEL_COMPARISON, PRODUCTION, BUCKET_NAME, SCALING_ACTIVE
...
class OptimizationExperiment:
    ...
    def run_single_iteration(self, original_result, canonical_from_original_result, 
        ...
        try:
            ...
            # === 2. Decide whether to apply scaling based on the environment variable ===
            if SCALING_ACTIVE:
